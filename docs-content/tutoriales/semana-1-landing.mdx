...
description: Setup completo, landing personalizada y waitlist capturando emails en producción.
order: 1
---
...
Sigue [Setup → Quick start](/docs/setup/quick-start) completo hasta el Paso 7. Tope: 30 min.
...
Sigue el [Paso 9 del quick start](/docs/setup/quick-start#paso-9). Cuando termines, comparte tu URL en el canal del curso.
