...
export default function Waitlist() {
  ...
  return (
    <section id="contact" className="scroll-mt-24 bg-[#FAF8F5] px-6 py-24">
          ...
          <form onSubmit={onSubmit} className="mt-10 space-y-4">
            <div>
              ...
              <input
                ...
                className="w-full rounded-lg border border-[#E8D8C8] bg-white px-4 py-3 text-sm text-[#252225] outline-none transition placeholder:text-[#A99CAF] focus:border-brand-navy/40 focus:ring-2 focus:ring-brand-navy/10"
            ...
            <div>
              ...
              <textarea
                ...
                className="w-full resize-y rounded-lg border border-[#E8D8C8] bg-white px-4 py-3 text-sm text-[#252225] outline-none transition placeholder:text-[#A99CAF] focus:border-brand-navy/40 focus:ring-2 focus:ring-brand-navy/10"
                disabled={status === "loading"}
              />
            </div>
            ...
            <button
              type="submit"
              disabled={status === "loading"}
              className="inline-flex w-full items-center justify-center rounded-full bg-[#D9A7B0] px-6 py-3.5 text-sm font-semibold text-[#4A2748] shadow-sm transition-colors duration-200 hover:bg-[#c48e99] disabled:opacity-60"
            >
