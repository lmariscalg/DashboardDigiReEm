...
const config = {
  ...
  brand: {
    ...
    primary: "#4A2748", // ciruela profundo — branding
    // Logo: puede ser texto o ruta a /public/logo.svg
    logoText: "LaBellaPro",
    logoSrc: "/LaBellaPro.svg",
  ...
  auth: {
    loginUrl: "/login",
    // Login de la app producto (LaBellaPro) — usado en el navbar de marketing
    externalLoginUrl: "https://la-bella-pro.vercel.app/login",
    ...
    footer: {
      ...
      columns: [
        ...
        },
        {
          title: "CONTACTO",
          links: [
            { label: "liliana.mariscal@gmail.com", href: "mailto:liliana.mariscal@gmail.com", icon: "mail" },
            { label: "WhatsApp +52 614 1892291", href: "https://wa.me/526141892291", external: true, icon: "message-circle" },
          ],
        },
      ],
      links: [],
