...
| Role | Hex | CSS Variable (daisyUI) |
|------|-----|--------------|
| Primary (marca) | `#7C3AED` | `--color-primary` |
| Primary content | `#FFFFFF` | `--color-primary-content` |
| CTA / Accent | `#F97316` | `--color-accent` |
| Accent content | `#FFFFFF` | `--color-accent-content` |
| Base 100 (superficie) | `#FFFFFF` | `--color-base-100` |
| Base 200 (fondo) | `#F8FAFC` | `--color-base-200` |
